...
/**
 * The ManagerController is the backing bean for the admin panel index page. It manages everything
 * from creating new polls, deleting polls, editing poll names and descriptions, adding and deleting
 * VoteGroups, and enabling/disabling polls.
 */
@ManagedBean
@ViewScoped
public class ManagerController {
  ...
  /**
   * These variables are used when editing the poll name/description so that input can be verified.
   */
